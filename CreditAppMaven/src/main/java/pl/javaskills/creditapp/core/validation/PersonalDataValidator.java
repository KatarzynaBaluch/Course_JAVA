...
public class PersonalDataValidator implements Validator{
    ...
    public void validate(LoanApplication loanApplication) throws ValidationException {
        ...
        ValidationUtils.validateNotNull("nameame", personalData.getName());
        ...
        ValidationUtils.validateMinValue("numOfFamilyDependends",0, loanApplication.getPerson().getNumOfFamilyDependends());
    }
}
